<!doctype html>
<!--
* Cics Faculty Attendance System
* Email: menquejanruwell21@gmail.com
* Version: 1.1
* Author: Jan Ruwell Menque
* Copyright 2020 Laravel System
-->
		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
							<div class="logo align-center"><img src="{{ asset('/assets/images/img/bkd.png') }}" alt="CICS"></div>
